...
import { Building2, CheckCircle2, AlertCircle, ExternalLink, MapPin, Briefcase } from 'lucide-react-native';
    ...
    return (
      <View className="flex-1 items-center justify-center py-12 px-6">
        <View className="bg-indigo-500/10 rounded-2xl items-center justify-center mb-6" style={{ width: 80, height: 80 }}>
          <Icon as={Building2} size={40} className="text-indigo-500 animate-pulse" />
        </View>
              ...
              <View className="flex-row items-start gap-3">
                <View className="flex-shrink-0">
                  {result.company_logo_url ? (
                    ...
                    <View className="bg-muted rounded-lg items-center justify-center" style={{ width: 48, height: 48 }}>
                      <Icon as={Building2} size={24} className="text-muted-foreground" />
                    </View>
                  )}
                </View>
