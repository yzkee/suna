...
-- ║                                                                            ║
-- ║  THIS FILE IS A COPY OF services/postgres/init/00-init-kortix.sql          ║
-- ║  Keep them in sync! When adding migrations, update BOTH files.             ║
-- ║                                                                            ║
-- ║  The postgres copy runs once on first container creation.                  ║
-- ║  This copy runs on every API startup via ensure-schema.ts to handle        ║
-- ║  upgrades where the postgres volume already has data.                      ║
-- ║                                                                            ║
...
-- ║    - 0003_server_entries.sql            (server entries table)             ║
-- ╚══════════════════════════════════════════════════════════════════════════════╝
