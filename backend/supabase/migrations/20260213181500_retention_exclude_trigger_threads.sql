-- Exclude trigger-originated threads from retention metrics.
-- This keeps recurring-user analytics focused on user-driven activity.
...
BEGIN
    ...
    WITH thread_weeks AS (
        -- Get all user-driven threads in the period and calculate which week they belong to
        SELECT
            t.account_id,
