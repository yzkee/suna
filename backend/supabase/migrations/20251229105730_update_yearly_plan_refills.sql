...
COMMENT ON FUNCTION process_monthly_refills IS 'Processes monthly credit refills for yearly plan subscribers (Stripe and RevenueCat) with correct credit amounts and 12-month limit check';
