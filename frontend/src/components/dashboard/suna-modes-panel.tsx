...
const modes: Mode[] = [
  ...
  },
  {
    ...
    samplePrompts: [
      'Create a social media banner with futuristic city skyline',
      'Design a minimalist coffee brand logo using earthy tones',
      'Remove background and add soft gradient to product photo',
      'Create a renewable energy infographic with flat design',
      'Design a sci-fi book cover with cyberpunk aesthetics',
      'Make a productivity tips YouTube thumbnail with bold text',
      'Create a luxury fashion mood board for millennials',
      'Design an elegant wedding invitation with floral patterns',
      'Edit portrait to vintage film look with grain and warm tones',
      'Create a music festival poster with psychedelic 70s vibes',
    ],
    options: {
