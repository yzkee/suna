...
export const config = {
  ...
  HETZNER_SNAPSHOT_DESCRIPTION: env.HETZNER_SNAPSHOT_DESCRIPTION
    || (env.HETZNER_SNAPSHOT_VERSION_OVERRIDE ? `kortix-computer-v${env.HETZNER_SNAPSHOT_VERSION_OVERRIDE}` : null)
